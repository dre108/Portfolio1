...
const portfolioData = {
    home: {
        overview: "I am a software developer from the south side of Chicago, specializing in full-stack development and modern web technologies. I strive to create impactful software that solves real-world problems.",
    ...
    work: {
        overview: "With over a year of professional experience in software engineering, I've had the opportunity to work on diverse projects that have enhanced my technical skills and business acumen. I've built full-stack applications, managed databases, and collaborated in agile teams to deliver quality software.",
        experience: [
            {
        ...
        projects: [
            {
                ...
                description: "Building modern web applications with a focus on performance and user experience. This project demonstrates my ability to create dynamic and efficient user interfaces.",
            ...
            },
            {
                ...
                description: "Designing and implementing efficient database solutions for scalable applications. This includes database normalization, performance tuning, and query optimization.",
            ...
            },
            {
                ...
                description: "Developed a full-stack e-commerce platform with user authentication, product management, and payment integration. Focused on responsive design and smooth checkout experience.",
                skills: ["React", "Node.js", "MongoDB", "RESTful API", "Authentication", "Payment Gateway Integration"],
    ...
    testimonials: {
        overview: "As a full-stack developer specializing in JavaScript, I've had the pleasure of working with amazing teams and clients. Here's what they have to say about our collaboration.",
        quotes: [
            {
...
function renderWork() {
  ...
  const projectsHTML = portfolioData.work.projects.map(project => `
